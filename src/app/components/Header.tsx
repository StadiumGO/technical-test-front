...
const Header: React.FC = () => {
  return (
    <header className="fixed bg-primary flex justify-center items-center md:flex-col gap-8 text-center h-28 md:h-screen md:p-10 w-full md:w-1/4 md:min-w-[300px]">
